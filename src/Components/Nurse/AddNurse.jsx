...
export default function nurseForm() {
  ...
  const handleOptionSelect = (option) => {
    setnurse({ ...nurse, address: option });
    setShowOptions(false);
  };

  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("nurse added:", nurse);
    // Example of a POST request
    axios
      .post("/api/add-nurse", nurse)
      .then((response) => {
        console.log(response.data);
        ToastMessage({ message: "nurse added successfully!", type: "success" });
      })
      .catch((error) => {
        console.error(error);
        ToastMessage({ message: "Error adding nurse.", type: "error" });
      });
  };
